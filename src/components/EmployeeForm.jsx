...
const EmployeeForm = () => {
    ...
    return (
        <div className="h-[83vh] flex items-center justify-center p-6 bg-[#111827]">
            <div className="bg-[#1F2937] rounded-xl shadow-lg p-8 w-full max-w-2xl">
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-gray-100 mb-2">Employee Management</h2>
                    <p className="text-gray-400">Add new employee to the system</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                type="text"
                                id="name"
                                className={`bg-[#374151] text-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 transition-all duration-200 ${
                                    error.name ? "border border-red-400" : "border border-gray-600"
                                }`}
                                placeholder="John"
                                required
                        ...
                        <div>
                            ...
                            <input
                                type="number"
                                id="salary"
                                className="bg-[#374151] border border-gray-600 text-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3"
                    ...
                    <div>
                        ...
                        <select
                            id="department"
                            className="bg-[#374151] border border-gray-600 text-gray-200 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-3"
                            onChange={handleChange}
                    ...
                    <div className="text-center pt-5">
                        <button
                            className="inline-flex items-center justify-center bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-all duration-200 font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                            type="submit"
                        >
